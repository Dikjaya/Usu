        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Semua Produk UMKM Wilayah Sumedang</h1>
                    ...
                    @foreach ($produks as $produk)
                        <div class="col mb-5">
                            <div class="card h-100">
                                <!-- Product image-->
                                <img class="card-img-top" src="https://source.unsplash.com/359x239/?Product" alt="..." />
                                <!-- Product details-->
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/detail_produk/{{ $produk->id }}">Lihat Detail</a></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
